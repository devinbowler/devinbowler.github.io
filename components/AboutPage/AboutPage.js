...
export class AboutPage extends BaseComponent {
  ...
  #setupContainerContent() {
    this.#container.innerHTML = `
      <section class="hero">
        ...
        <h1 class="hero-headline">Building software and chasing meaningful experiences.</h1>
  ...
  <div class="about-content">
    <p>I am a recent graduate from the University of Massachusetts with a Bachelor's in Computer Science. I am actively seeking a full-time position and am open to opportunities where I can contribute, learn, and grow. My experience spans startup development and research at both Texas State University and the University of Houston, where I focused on machine learning, networking techniques, and software engineering. Most recently, I have been working as a engineer at an early-stage healthcare technology startup, helping build software designed to improve communication and documentation within clinical environments.</p>
  
    <p>As an engineer at Synaptix, I have had the opportunity to work on a wide range of challenges involved in building a product from the ground up. I have contributed to both frontend and backend development, helped build core platform features, developed APIs and supporting services, and worked closely with team leads to better understand how technology can fit into real clinical workflows. One of the most rewarding aspects of the experience has been seeing ideas move from conversations and prototypes into working software that can be demonstrated to potential users and stakeholders. Beyond the technical work, I have learned the importance of adaptability, communication, and balancing engineering decisions with the practical realities of building a business.</p>
    ...
    <p>I believe the process of creating is as valuable if not more valuable than the end result. Each project offers lessons, and I approach every task with an open mind, embracing challenges and exploring ideas. In this field, I find inspiration in the endless possibilities ahead and the role we can play in shaping the future through thoughtful, meaningful technology.</p>
  </div>
    `;
